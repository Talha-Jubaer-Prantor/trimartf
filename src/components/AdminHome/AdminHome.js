    ...
    <div>
      ...
      {orederItems.map((orederItem) => (
        ...
        <div className="order-sec">
          ...
          <button type="button" onClick={()=>handleConfirmOrder(orederItem._id)} className="btn btn-success">Confirm Order</button>
          <button type="button" onClick={()=>handleDeleteOrder(orederItem._id)} className="btn btn-danger">Delete Order</button>
        </div>
      ))}
    </div>
  );
